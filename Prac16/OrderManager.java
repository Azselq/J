...
public class OrderManager {
    ...
    public boolean add(int tableNumber, RestaurantOrder order) throws
            Exception {
    ...
    public HashMap<Integer, RestaurantOrder> getRestaurantOrderHashMap() {
        return restaurantOrderHashMap;
    }
    public HashMap<String, InternetOrder> getInternetOrderHashMap() {
        return internetOrderHashMap;
    }

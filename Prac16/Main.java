...
public class Main {
    public static void main(String[] ar) {
        ...
        try {
            ...
            System.out.println("Стоимость заказа в ресторане");
            System.out.println(restaurantOrder.priceTotal());
            System.out.println("Сводная информация о стоимости заказа в ресторане");
            System.out.println(orderManager.RestaurantOrdersCostSummary());
            System.out.println("Количество блюд");
            System.out.println(restaurantOrder.dishQuantity());
            System.out.println("Количество блюд в доставке");
            System.out.println(internetOrder.getCount());
            System.out.println("Стоимость заказа в доставке");
